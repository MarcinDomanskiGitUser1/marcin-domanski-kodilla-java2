...
public class FacebookTestingApp {
    private static final String BIRTHDAY_PATH = "//div[contains(@class, \"_5k_5\")]/span/span/";
    private static final String XPATH_SELECT_DAY = BIRTHDAY_PATH + "select[1]";
    private static final String XPATH_SELECT_MONTH = BIRTHDAY_PATH + "select[2]";
    private static final String XPATH_SELECT_YEAR = BIRTHDAY_PATH + "select[3]";
